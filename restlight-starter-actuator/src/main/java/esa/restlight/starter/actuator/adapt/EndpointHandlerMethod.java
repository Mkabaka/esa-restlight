...
class EndpointHandlerMethod extends HandlerMethod implements InvocableMethod {
    ...
    private EndpointHandlerMethod(WebOperation op) {
        super(OperationHandler.class, HANDLE_METHOD, new OperationHandler(op));
    }

    static HandlerMethod forSpringMvc(WebOperation op) {
        return new EndpointHandlerMethod(op);
    }

    static HandlerMethod forJaxrs(WebOperation op) {
        return new HandlerMethod(OperationHandler.class, HANDLE_METHOD, new OperationHandler(op)) {
            @Override
